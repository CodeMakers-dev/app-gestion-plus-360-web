...
export class MensajesMasivosComponent implements OnInit {
  data: MensajesMasivos[] = [
    { titulo: 'Venta Accesorios', descripcion: 'Silver', fechaCreacion: '2023-01-01', archivo: '$2999' },
    { titulo: 'Venta Accesorios', descripcion: 'White', fechaCreacion: '2023-01-02', archivo: '$1999' },
    { titulo: 'Venta Accesorios', descripcion: 'Black', fechaCreacion: '2023-01-03', archivo: '$99' }
  ];
  ...
  navegarHistorial() {
    this.router.navigate(['marketing/historial']);
  }
}
